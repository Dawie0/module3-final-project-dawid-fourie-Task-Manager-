...
const UserInfo = () => {
    ...
    const { currUserData, updateCurrentUser } = useContext(ValidUserContext)
    const [organization, setOrganization] = useState('')
    const [position, setPosition] = useState('')
    const [positionType, setPositionType] = useState('Select Position Type')

    useEffect(() => {
        if (currUserData.user_details) {
            navigate('/')
        }
    }, [currUserData])
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (organization.trim() === '' || position.trim() === '' || positionType === '') {
                ...
                await axios.put(
                    `https://task-manager-backend-three.vercel.app/api/users-update/${currUserData._id}`, 
